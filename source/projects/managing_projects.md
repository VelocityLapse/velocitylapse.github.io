...
Each project is shown with a thumbnail of the most recent image, the name of the project, the date that the project was last edited, the number of images (called "frames") in the project, and the image resolution.
